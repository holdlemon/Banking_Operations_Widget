...
def filter_by_currency(transact: List[Dict], currency: str = "USD") -> Generator[Dict[str, object], None, None]:
...
def transaction_descriptions(transact: List[Dict[str, Any]]) -> Generator[object, None, None]:
